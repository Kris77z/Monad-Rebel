...
const EN_US_MESSAGES: MessageDictionary = {
  ...
  'onboarding.terminal.target': '> Target: Monad Testnet · Chain 10143',
  ...
  'onboarding.terminal.network': '✓ Network: Monad Testnet',
...
const ZH_CN_MESSAGES: MessageDictionary = {
  ...
  'preset.cancel': '取消',
  'preset.execute': '执行',
  'preset.goal.write': '写一篇简洁分析，说明 Monad 并行执行机制及其对链上 AI Agent 的意义。',
  ...
  'preset.goal.defiStrategy': '制定一套 Monad 上的 DeFi 策略：先分析当前收益环境，再扫描头部协议代币的安全性，最后给出书面化的资产配置方案。',
  ...
  'onboarding.connect.body': '你的钱包会绑定到 Monad 上的 Agent 身份。',
  ...
  'onboarding.complete.body': '{name} 已在 Monad 上就绪。',
  'onboarding.complete.createAnother': '继续创建',
  'onboarding.complete.goDashboard': '进入控制台',
  'onboarding.terminal.target': '> 目标网络：Monad 测试网 · Chain 10143',
  'onboarding.terminal.ready': '> 已准备好注册一个自治 Agent。',
  'onboarding.terminal.command.init': '$ rebel-mesh 初始化',
  ...
  'onboarding.terminal.command.registerPreview': '$ rebel-mesh 注册 --预览',
  'onboarding.terminal.command.registerConfirm': '$ rebel-mesh 注册 --确认',
  'onboarding.terminal.connected': '✓ 已连接：{address}',
  'onboarding.terminal.network': '✓ 网络：Monad 测试网',
  ...
  'onboarding.terminal.demoModeNotice': '✓ Agent 已成功注册。\n\n[提示] 当前 Vercel 部署仅作为展示。为了您的安全，完整的 Dashboard 与特权通信已被限制在本地。请克隆仓库在本地拉起完整的 Agent-to-Agent 支付与指令网络。',
  ...
  'timeline.summary.payment.quotedStatus': '报价 {amount} MON，状态：{status}。',
  'timeline.summary.payment.quoted': '已收到报价：{amount} MON。',
  ...
  'timeline.summary.complete.closed': '任务已结束。评分 {score}/10，总花费 {amount} MON。',
  'timeline.summary.complete.default': '任务流程已完成。',
  'narrative.idle': 'mission.log',
  'narrative.done': '已完成',
  'narrative.inSeconds': '{seconds}秒',
  'narrative.spent': '已花费 {amount} MON',
  ...
  'narrative.quote': '已收到报价：{amount} MON',
  ...
  'trace.price': '价格：{amount} MON',
  'trace.viewOnExplorer': '在 MonadScan 查看',
